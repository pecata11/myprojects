package org.apache.jsp.WEB_002dINF.jsp.assignLessons;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class assignLessons_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/jsp/assignLessons/../header.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t \t$('.tableScrollerWrapper').load('/api/assignLessons/getSearchLessons?lessonIds=' + searchLessonIds +' #loadedContent');\n");
      ...
      out.write("\t $.ajax({\n");
      out.write("\t        url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ajaxPicksGroupsAndStudents}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("',\n");
      out.write("\t        type:'GET',\n");
      ...
      out.write("\t\t\t    }\n");
      out.write("\t\t   \t\t\n");
      out.write("\t\t   \t\t$('#studentId').html(listItems);\n");
      out.write("\t        }\n");
      out.write("\t      });\n");
      out.write("\t});\n");
      out.write("\t\n");
      out.write("function clearStudentPlayList() {\n");
      out.write("\tvar classId = $('#classId').val();\n");
      out.write("\tvar studentId = $('#studentId').val();\n");
      out.write("\t $.ajax({\n");
      out.write("\t        url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ajaxclearStudentPlayList}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("',\n");
      out.write("\t        type:'GET',\n");
      out.write("\t        data: ({classId : classId, studentId : studentId}),\n");
      out.write("\t    \tdataType: \"json\",\n");
      out.write("\t    \tcomplete: function(transport){\n");
      out.write("\t    \t\tvar data = transport.responseText;\n");
      ...
      out.write("}\n");
      out.write("\n");
      out.write("$(\"#assignl\").click(function(event){\n");
      out.write("\tvar n = $(\"input:checked[id^='lessonIds']\").length;  \n");
      out.write("\tif(n == 0){\n");
      out.write("\t\talert(\"Please, select lessons for assignment.\");\n");
      out.write("\t\tevent.preventDefault();\n");
      out.write("\t}\t\n");
      out.write("});\n");
      out.write("\n");
      out.write("function recommendMore(component){\n");
      out.write("\tvar classId = $('#classId').val();\n");
      out.write("\tvar studentId = $('#studentId').val();\n");
      out.write("\t\n");
      out.write("\tif(component.val() == 1){\n");
      out.write("\t\t$('.tableScrollerWrapper').load('/api/assignLessons/recommendLesons?classId=' + classId + '&studentId=' + studentId + '&lessonId=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${assignBean.lessonId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write(" #loadedContent');\n");
      out.write("\t}\n");
      out.write("\tif(component.val() == 3){\n");
      out.write("\t\tclearStudentPlayList();\n");
      out.write("\t}\n");
      out.write("\tif(component.val() == 2){\n");
      out.write("\t\t$('.tableScrollerWrapper').load('/api/assignLessons/currLesons?classId=' + classId + '&studentId=' + studentId + ' #loadedContent');\n");
      out.write("\t}\n");
      out.write("\tif(component.val() == 4){\n");
      out.write("\t\t window.location = \"/api/searchLessons/search/\";\n");
      out.write("\t\t localStorage.setItem('callPageUrl', \"/api/assignLessons/student\");\n");
      out.write("\t\t var callPageUrl = localStorage.getItem('callPageUrl');\n");
      out.write("\t}\n");
      out.write("}\n");
      out.write("\n");
      out.write("$('#studentId').change(function() {\n");
      out.write("\trecommendMore($('#idMoreOptions'));\n");
      out.write("});\n");
      out.write("\t\n");
      out.write("</script>\n");
      out.write("\n");
  ...
  private boolean _jspx_meth_c_005furl_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(4,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f0.setVar("logoutUrl");
    // /WEB-INF/jsp/assignLessons/../header.jsp(4,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_sec_005fauthorize_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(9,6) name = ifAnyGranted type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(11,8) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f1.setVar("dashboardUrl");
    // /WEB-INF/jsp/assignLessons/../header.jsp(11,8) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(14,8) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f2.setVar("adminUrl");
    // /WEB-INF/jsp/assignLessons/../header.jsp(14,8) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(17,8) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f3.setVar("lessonUrl");
    // /WEB-INF/jsp/assignLessons/../header.jsp(17,8) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(20,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f4.setVar("lessonUrl");
    // /WEB-INF/jsp/assignLessons/../header.jsp(20,5) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(23,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f5.setVar("goalUrl");
    // /WEB-INF/jsp/assignLessons/../header.jsp(23,5) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_sec_005fauthorize_005f1(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(30,2) name = ifAnyGranted type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f1, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(31,3) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f6.setVar("listUrl");
    // /WEB-INF/jsp/assignLessons/../header.jsp(31,3) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f1, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(32,3) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f7.setVar("studentDashboardUrl");
    // /WEB-INF/jsp/assignLessons/../header.jsp(32,3) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_sec_005fauthorize_005f2(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(39,8) name = ifAnyGranted type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f2, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(40,3) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f8.setVar("createQuizUrl");
    // /WEB-INF/jsp/assignLessons/../header.jsp(40,3) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f2, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/../header.jsp(42,9) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f9.setVar("homeUrl");
    // /WEB-INF/jsp/assignLessons/../header.jsp(42,9) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f10(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(23,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f10.setVar("ajaxPicksGroupsAndStudents");
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(23,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f10.setValue("/api/assignLessons/groups");
  ...
  private boolean _jspx_meth_c_005furl_005f11(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(24,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f11.setVar("ajaxclearStudentPlayList");
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(24,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f11.setValue("/api/assignLessons/clear");
  ...
  private boolean _jspx_meth_c_005furl_005f12(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(29,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f12.setVar("saveUrl");
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(29,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005furl_005f12.setValue("/api/assignLessons/student");
  ...
  private boolean _jspx_meth_form_005fform_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(31,0) name = modelAttribute type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fform_005f0.setModelAttribute("assignBean");
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(31,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fform_005f0.setMethod("POST");
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(31,0) name = action type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(31,0) null
    _jspx_th_form_005fform_005f0.setDynamicAttribute(null, "class", new String("niceForm"));
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(31,0) name = id type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fform_005f0.setId("idForm");
    ...
    try {
      ...
      if (_jspx_eval_form_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t<br></br>\n");
          out.write("\t\n");
          out.write("\t<select id=\"idMoreOptions\" onchange=\"javascript:recommendMore($(this))\">\n");
          out.write("\t  <option value=\"1\">Recommend More</option>\n");
          out.write("\t  <option value=\"4\">Assign Other Lessons</option>\n");
          out.write("\t  <option value=\"2\">Show Currently Assigned Lessons</option>\n");
          out.write("\t  <option value=\"3\">Clear Playlist</option>\n");
          out.write("\t</select>\n");
          out.write("\t\n");
          out.write("\t<br></br>\n");
          out.write("\t");
          if (_jspx_meth_form_005fcheckbox_005f1(_jspx_th_form_005fform_005f0, _jspx_page_context, _jspx_push_body_count_form_005fform_005f0))
            return true;
          out.write("  Quiz (just questions and answers)\n");
          out.write("\t<br></br>\n");
          out.write("\t<input type=\"submit\" id=\"assignl\" value=\"Assign Selected\" name=\"next\" class=\"button grey\"/>\n");
  ...
  private boolean _jspx_meth_form_005fselect_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(33,1) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fselect_005f0.setPath("classId");
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(33,1) name = cssStyle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005foptions_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fselect_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fselect_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(34,5) name = items type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005fselect_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(37,1) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fselect_005f1.setPath("studentId");
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(37,1) name = cssStyle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005foptions_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fselect_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fselect_005f1)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(38,5) name = items type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005foptions_005f1.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${students}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(46,2) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${lessons}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(46,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("al");
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(46,2) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(47,14) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005fcheckbox_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(48,8) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fcheckbox_005f0.setPath("lessonIds");
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(48,8) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fcheckbox_005f0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${al.id}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fout_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(49,8) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${al.name}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(51,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${al.grade != null && al.grade != '-1'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fout_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(52,5) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f1.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${al.grade}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(54,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${al.subject != null && al.subject != '-1'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fout_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(55,6) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f2.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${al.subject}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fif_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(57,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${al.strand != null && al.strand != '-1'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fout_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f3, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(58,6) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f3.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${al.strand}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fif_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(60,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f4.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${al.objective != null && al.objective != '-1'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_005fif_005f4 = _jspx_th_c_005fif_005f4.doStartTag();
    if (_jspx_eval_c_005fif_005f4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t\t\t\t\t/");
        if (_jspx_meth_c_005fout_005f4(_jspx_th_c_005fif_005f4, _jspx_page_context, _jspx_push_body_count_c_005fforEach_005f0))
          return true;
        out.write("\n");
        out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fout_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f4, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:out
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(61,6) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f4.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${al.objective}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_form_005fcheckbox_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(83,1) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fcheckbox_005f1.setPath("isQuiz");
    // /WEB-INF/jsp/assignLessons/assignLessons.jsp(83,1) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fcheckbox_005f1.setCssClass("chb");
