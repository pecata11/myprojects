...
@synthesize baseDate,baseDateOld, fromDate, toDate, daysInSelectedMonth, daysInFinalWeekOfPreviousMonth, daysInFirstWeekOfFollowingMonth;
...
- (void)swapTheYear
{
    ...
    NSString *dateE = [dateFormat stringFromDate:self.baseDate]; 
    NSString* changedYearDateString=[Utils changeYearToCurrent:dateE];
    NSDate *dateChanged=[dateFormat dateFromString:changedYearDateString];
    self.baseDateOld = self.baseDate;
    self.baseDate = dateChanged;
    [dateFormat release];
}
